...
@media(max-width:620px){.champion-card{padding-top:48px!important}.champion-card:before{top:12px!important;width:48px!important;height:25px!important}.draft-intel{grid-template-columns:1fr!important}.intel-card{min-height:0!important}.intel-card b{font-size:29px!important}.pick .meta{align-items:flex-end!important}.ppg-value{font-size:19px!important}.bar strong{font-size:14px!important}.bar small{display:block!important;font-size:10px!important}.axis-label{font-size:10px!important}.point-label{font-size:9px!important}}
